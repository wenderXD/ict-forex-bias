export const t = {
  ...
  referenceLevels: "Reference Levels",
  current: "Current",
  premiumSell: "Premium · sell-side",
  discountBuy: "Discount · buy-side",
  equilibriumFair: "Equilibrium · fair value",
  communityBias: "Community Bias",
