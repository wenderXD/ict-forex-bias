"""
ai_narrative.py
Generates ICT bias narratives using AI AI-opus-4-6 (AI API).
...
def generate_ai_narrative(analysis: ICTAnalysis, date: str) -> str:
    """
    Call AI AI-opus-4-6 to generate the narrative.
    Returns the AI narrative string, or falls back to the rule-based one on error.
    """
    api_key = os.environ.get("AI_API_KEY")
    if not api_key:
        print(f"    [ai_narrative] AI_API_KEY not set — using rule-based narrative")
